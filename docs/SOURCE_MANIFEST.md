...
| `RELATIONSHIPS.md` | Supplied Sep 2026 | Relationship synthesis | User-supplied | Cross-character history | Relationship triggers, asymmetries, reversals, and consequences | Relationships in Motion, character dossiers |
| `REGIONS_FACTIONS_INSTITUTIONS.md` | Supplied Sep 2026 | Regional and institutional synthesis | User-supplied | Prima, Gael, Fein Uaill, factions | Geographic hierarchy, institutions, regional chronology | Location articles, atlas, faction coverage |
| `COSMOLOGY_AND_METAPHYSICS.md` | Supplied Sep 2026 | Cosmology synthesis | User-supplied | Ada, caretakers, Tree, Delerium, souls | Established metaphysical structure and dangerous unknowns | Cosmology guide, divine profiles, unresolved record |
...
| `The_Common_Man_Location_Profile_and_History.md` | Supplied Sep 2026 | Location profile | User-supplied | Common Man and Pilgrim's Hearth | Civilian history, ordinary life, destruction, rebuilding | `The Common Man` article and timeline |
| `The_Void_Location_Profile_and_History.md` | Supplied 24 Sep 2026 | Location profile | User-supplied | The Void and interregional travel | Travel history, predator-space, soul-fed passage, uneven knowledge, communication, and unresolved mechanics | `The Void` article, atlas, timeline, cosmology links |
| `Voraketh_Location_Profile_and_History.md` | Supplied 24 Sep 2026 | Location profile | User-supplied | Voraketh, the Maw, and Delerium Chain | Local testimony, direct observations, suppression, theories, evidence limits, and open identities | `Voraketh` article, atlas, timeline, Ithilrûnë and Sildithas dossiers |
| `Olokun_Ultimate_Character_History_and_Codex_Profile.md` | Supplied 24 Sep 2026 | Character profile | User-supplied | Olokun / Olo | Full chronology, protection-without-ownership thesis, Aria, Rahu, Arjahn, death, resurrection, contradictions, and retrieval anchors | `Olokun` article, timeline, quotation archive, master summary |
| `Fenumion_Codex_Words_the_World_Remembers.md` | Supplied 24 Sep 2026 | Quotation synthesis | User-supplied | Memorable speech across the setting | Exact recovered wording, speakers, dates, scene context, and thematic constellations | Memorable Quotes, related character dossiers, quote attribution correction |
